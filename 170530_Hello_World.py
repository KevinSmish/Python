...
# c - continue - продолжить до ошибки или до конца программы
# s - step	- сделать 1 шаг по коду
# n - next	- следующий шаг без захода в функцию
# l - list	- увидеть несколько следующих строк кода
# b 6 		- поставить точку останова на строке кода 6
# p MyVar	- напечатать значение переменной MyVar
# q - quit	- закончить отладку
#----------------------------------------------------------------------------------------------- 001_HelloWorld.py
# -*- coding: cp1251 -*-
...
# ------
print()
print('12/10=',12/10)		# 12/10=1.2 (Обычное деление)
print('12//10=',12//10)		# 12//10=1  (Деление нацело)
print('12%10=',12%10)		# 12%10     (Остаток от деления)
#----------------------------------------------------------------------------------------------- 002_Types.py
